...
enum ExpTypes {OPERANDO, OPERADOR, EXP_VARIAVEL, EXP_NUMBER, OPERADOR_PLUS, OPERADOR_SUB, OPERADOR_MULT, OPERADOR_DIV, EXP_STRING, EXP_INC, EXP_DEC, EXP_ASSIGN,
    EXP_LSHIFT, EXP_RSHIFT, EXP_FUNC, OPERADOR_BITWISE, PLUS_EXP, POINTER_EXP, ARRAY_EXP, CMP_LESST, CMP_LESSEQ, CMP_GREATERT, CMP_GREATEREQ, MATRIX_EXP, TERN, RET_TERN, CAST};
